...
private:
	...
	struct SpriteElement {
		std::unique_ptr<DxObject::VertexDimensionBuffer<SpriteInputAssembler>> vertex;
		std::unique_ptr<DxObject::DimensionBuffer<SpriteInfo>>                 info;
	...
	std::unique_ptr<DxObject::IndexDimensionBuffer> index_; //!< indexBufferは共通

	std::unique_ptr<DxObject::DimensionBuffer<Matrix4x4>> projection_;
